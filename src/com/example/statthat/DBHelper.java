...
public class DBHelper {
	...
	private static void populateStatsForGame(Context c, Game game, List<Player> players) {
		...
		new Stat(c, players.get(11), game, type6, 2.0, 1, true, null).save();
		new Stat(c, players.get(11), game, type4, 41.0, 3, false, null).save();
		new Stat(c, players.get(12), game, type5, 21.0, 2, false, null).save();
		new Stat(c, players.get(11), game, type4, 17.0, 1, true, null).save();
